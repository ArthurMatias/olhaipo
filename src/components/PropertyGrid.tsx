...
const mockPropertiesOld = [
  ...
  },
  {
    ...
    reviewCount: 203,
    imageUrl:
      "https://images.unsplash.com/photo-1695128861516-d9b48461c04c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwYXJ0eSUyMHZlbnVlJTIwdGVycmFjZSUyMGNlbGVicmF0aW9ufGVufDF8fHx8MTc1Nzk4NzEzOXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    capacity: 100,
    type: "Terraço",
  },
  {
    ...
    reviewCount: 67,
    imageUrl:
      "https://images.unsplash.com/photo-1687213280116-234f93b15b44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwdmVudWUlMjBwYXJ0eSUyMGhhbGwlMjBlbGVnYW50fGVufDF8fHx8MTc1Nzk4NzE0MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    capacity: 150,
    type: "Mansão",
  },
  {
...
export function PropertyGrid({ onPropertyClick }: PropertyGridProps) {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          No olhaipô, encontre o espaço perfeito para sua celebração e crie
